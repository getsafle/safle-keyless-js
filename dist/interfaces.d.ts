...
export interface IConnectionMethods {
    ...
    signData: (msgParams: any) => Promise<{
        error: string;
        result: string;
    }>;
    ...
    processTransaction: (msgParams: any) => Promise<{
        error: string;
        result: string;
    }>;
    signTransaction: (msgParams: any) => Promise<{
        error: string;
        result: string;
    }>;
    getBlockByNumber: () => Promise<{
        error: string;
        result: string;
    }>;
    init: (state?: boolean) => Promise<{
        error: string;
        result: string;
    }>;
}
